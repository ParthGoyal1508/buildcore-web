...
and sign-in). Projects is a **desktop surface**: the BOQ tree, RA bills, work orders and portfolio views are project-management work done at a desk. (Note the plan's Constitution Check mislabels this row 'V.'; it is Principle VI.)
