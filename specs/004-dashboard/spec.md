...
and sign-in). The dashboard is a **desktop surface**: it is a multi-widget analytical overview read at a desk, and its widget tables are exactly the dense tabular data that card layouts hurt.
